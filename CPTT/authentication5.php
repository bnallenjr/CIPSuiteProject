...
@$bd = ldap_bind($ldap,$username,$password) or die("<h1>Authentication failed. Please check your username/password and <a href=NetworkApproval.php?Tracking_Num=$Tracking_Num>try again</a></h1>");
...
echo "Login successful, $username. CIP Personnel Tracking Tool access granted. <a href=home.php>Click Here</a>";
      ...
      $_SESSION["authenticated"] = 0;
        echo "Authentication failed. Please check your username/password and <a href=NetworkApproval.php?Tracking_Num=$Tracking_Num>try again</a>";
}

// Close the connection
ldap_unbind($ldap);
header ("Location: NetworkApproval.php?Tracking_Num=$Tracking_Num");
?>
