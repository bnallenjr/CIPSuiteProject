...
';
				...
				$o .= '	
					<h3>Please provide '.$record['Name'].' with authorized electonic access to the following system(s)/applications(s) that are answered as "Yes".</h3>
					<table border="1">
					<tr>
					<th>Name:</th>
					<td>'.$record ['Name'].'</td>
...
<p></p>
<p></p>
NOTE: Be sure to attach and send before and after screenshots (or system-generated reports) to this link <a href="mailto:allensolutiongroup@gmail.com?subject='.$record['Tracking_Num'].' - '.$record['Name'].'">Personnel Evidence Repository</a>. Please use "'.$record['Name'].'-NetworkReq-'.$date.'" as the file name.';
				}
			$o .= '</table>';
...
$subject = "Network Device(s) Request";
