...
function sendHtmlMail($to, $subject, $html, $replyTo = null, $replyToName = null) {
    ...
    $smtpPass = getenv('SMTP_PASS') ?: 'lpjhvaeaxojqofbn'; // app password, no spaces
...
<html lang="en">
<head>
  <title>XAECS Authorization Approval</title>
  <meta charset="utf-8">
...
if($conn) {
 ...
 $Tracking_Num = $_GET['Tracking_Num'];
		$result = sqlsrv_query($conn, "SELECT dbo.PersonnelInfo.Tracking_Num, dbo.PersonnelInfo.FirstName, dbo.PersonnelInfo.LastName, CONVERT (varchar, dbo.XA21_ECS.XAECS_Approved_On, 109) AS XAECS_Approved_On, dbo.XA21_ECS.XAECS_Approved_By 
...
?>
<div class="container">
	<h2 align ="center" >CIP Authorization Approval for XAECS Access</h2>
</div>
	...
	echo	"<div class='container'>
      ...
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <form role='form' method='post' action='authentication8.php?Tracking_Num=$Tracking_Num'>
...
<div class="well well-sm" align="center" ><h3>Complete XAECS Approval for <?php echo ''.$FirstName.' '.$LastName.'';?></h3></div>  
    <div class="form-group">
...
if (isset($_POST['XAECS_Approved_On']))
{
...
if ($Tracking_Num == '' || $XAECS_Approved_On== '')
{
$error = 'Error: Please fill in all required fields';
renderForm($Tracking_Num, $XAECS_Approved_On, $error);
}
else
{	
...
if ($row)
{
		...
		renderForm($Tracking_Num, $FirstName, $LastName, $XAECS_Approved_On, $XAECS_Approved_By, '');
}
else 
{
echo "No results!";
