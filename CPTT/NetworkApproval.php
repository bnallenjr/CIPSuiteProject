...
if($conn) {
 ...
 $Tracking_Num = $_GET['Tracking_Num'];
		$result = sqlsrv_query($conn, "SELECT dbo.PersonnelInfo.Tracking_Num, dbo.PersonnelInfo.FirstName, dbo.PersonnelInfo.LastName, CONVERT (varchar, dbo.NetworkDevices.Network_Approved_On, 109) AS Network_Approved_On, dbo.NetworkDevices.Network_Approved_By 
...
?>
<div class="container">
	<h2 align ="center" >CIP Authorization Approval for Network Device Access</h2>
</div>
...
renderForm($Tracking_Num, $Network_Approved_On, $error);
}
else
{	
...
if ($row)
{
		...
		renderForm($Tracking_Num, $FirstName, $LastName, $Network_Approved_On, $Network_Approved_By, '');
}
else 
{
echo "No results!";
