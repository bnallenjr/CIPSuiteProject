...
$conn = sqlsrv_connect($serverName, $connectionInfo);
		...
		$ServiceDeskPlus=$POST['ServiceDeskPlus'];
		...
		$sql = "INSERT INTO dbo.PersonnelInfo (FirstName, LastName, Status, Department, Title, FOC_Company, Contractor, Contract_Agency, Manager, SSN_Validation_Date, Criminal_Background_Date, CurrentTrainingDate, DatePaperWorkSign, Business_Need, Email, Initial_Ticket) 
										VALUES ('$FirstName', '$LastName', '$Status', '$Department', '$Title', '$FOC_Company', '$Contractor', '$Contract_Agency', '$Manager', '$SSN_Validation_Date', '$Criminal_Background_Date', '$CurrentTrainingDate', '$DatePaperWorkSign', '$Business_Need', '$Email', '$Initial_Ticket')";
		...
		$sql = "INSERT INTO dbo.PhysicalAccess (SCC, ECC, ECDA_Offices, ECMS_Offices, Operations_Data_Center, Server_Lobby, SNOC, JacksonGate, Restricted_Key,  LAW_Perimeter, LAW_Data_Center, LAW_SNOC, LAW_Generation, LAW_Transmission, LAW_Main_Elec, LAW_OperStor, LAW_Network_Room_104, Tracking_Num) 
							VALUES ('$SCC', '$ECC', '$ECDA_Offices', '$ECMS_Offices', '$Operations_Data_Center', '$Server_Lobby', '$SNOC', '$JacksonGate', '$Restricted_Key', '$LAW_Perimeter', '$LAW_Data_Center', '$LAW_SNOC',
		...
		$sql = "INSERT INTO dbo.OCRS (OCRS_ECMSAdmin, OCRS_SSITAdmin, OCRS_User, CIP_ProtectedInfo, Tracking_Num, Stratus, Catalogic, SolarWinds) 
...
<?php if($_POST['LAW_Maintenance_Electric'] =="Yes") { ?><tr><td>LAW-Maintenance & Electric Room:</td><td><?php echo($_POST['LAW_Maintenance_Electric']); ?></td></tr><?php } ?>
<?php if($_POST['LAW_Operations_Storage'] =="Yes") { ?><tr><td>LAW-Operations Storage:</td><td><?php echo($_POST['LAW_Operations_Storage']); ?></td></tr><?php } ?>
