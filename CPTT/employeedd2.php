...
<div class="form-group">
  <div class="col-sm-4">
<h4>Please Select Individual:</h4>
<select class="form-control" name="Employee" onchange="document.form2.keyword2.value=this.value"><option>Select Individual</option>
