...
@$bd = ldap_bind($ldap,$username,$password) or die("<h1>Authentication failed. Please check your username/password and <a href=index.php>try again</a></h1>");


if ($bd) {
      $_SESSION['authenticated'] = 1;
echo "Login successful, $username. CIP Personnel Tracking Tool access granted. <a href=index.php>Click Here</a>";
}
else {
      $_SESSION["authenticated"] = 0;
        echo "Authentication failed. Please check your username/password and <a href=index.php>try again</a>";
}
