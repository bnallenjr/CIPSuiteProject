<?php
 ...
 function renderForm($Tracking_Num, $FirstName, $LastName, $Status, $Department, $Title, $FOC_Company, $Contractor, $Contract_Agency, $Manager, $SSN_Validation_Date, $Criminal_Background_Date, $CurrentTrainingDate,
...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
	...
	<body>
	<div class="container">
	<h3  align ="center" >Individual Access Report</h3>
</div>
...
<table class ="table table-striped table-bordered table-condensed" id="confirmation2" align="center">
		...
		<tr>
			<td>Date Access Authorization Approved </td>
...
%0A
<?php if($row['SCC']=="Yes" OR $row['ECC']== "Yes" OR $row['BCC']=="Yes" OR $row['ECDA_Offices']=="Yes" OR $row['ECMS_Offices']=="Yes" OR $row['Operations_Data_Center']=="Yes" OR $row['Server_Lobby'] OR $row['SNOC']=="Yes") { ?>%0APhysical Access<?php } ?>
...
<?php if($row['TE_Engineering_OM_Group']=="Yes" OR $row['TelecomSharedAccount']=="Yes" OR $row['ACS_LocalAdmin']=="Yes" OR $row['RSA_LocalAdmin']=="Yes") { ?>%0AEACMS / Network Devices<?php } ?>
...
<?php if($row['OCRS_User']=="Yes" OR $row['OCRS_SSITAdmin']=="Yes" OR $row['OCRS_ECMSAdmin']=="Yes" OR $row['CIP_ProtectedInfo']=="Yes" OR $row['Stratus']=="Yes" OR $row['Catalogic']=="Yes" OR $row['SolarWinds']=="Yes" OR $row['ServiceDeskPlus']=="Yes") {?>%0ABCSI - Storage Repositories<?php } ?>
...
if ($row)
{
		...
		renderForm($Tracking_Num, $FirstName, $LastName, $Status, $Department, $Title, $FOC_Company, $Contractor, $Contract_Agency, $Manager, $SSN_Validation_Date, $Criminal_Background_Date, $CurrentTrainingDate,
                     $DatePaperWorkSign, $Email, $Business_Need, $Last_Individual_Review, $SCC, $ECC, $BCC, $BCC_Bunker, $ECDA_Offices, $ECMS_Offices, $Operations_Data_Center, $Server_Lobby, $SNOC, $JacksonGate, $Restricted_Key, $LAW_Perimeter, $LAW_Data_Center,
					 $LAW_SNOC, $LAW_Generation, $LAW_Transmission, $LAW_Main_Elec, $LAW_OperStor, $LAW_Network_Room_104,
					 $Sys_Ops_Domain_Administrator, $Sys_Ops_Domain_Contractor, $Sys_Ops_Domain_User, $Access_Control_Application_Administrator, $Access_Control_System_User, $CCTV_Video_Application_Administrator, $CCTV_Video_User, $PSS_WinAdmin, $ESP_Remote_Intermediate, 
					 $VPN_Tunnel_Access, $Logins_Gen_Tran, $Trans_Login, $Gen_Login, $AppSupport_Login, $AD_prod, $AD_supp, $UNIX_Access, $Internal_EnterNet, $External_EnterNet, $Database_User, $AutoCAD_User, $Sudo_root, $Sudo_XA21, $Sudo_xacm, $Sudo_oracle, $Sudo_ccadmin,
