...
@$bd = ldap_bind($ldap,$username,$password) or die("Authentication failed. Please check your username/password and <a href=cipapproval.php?Tracking_Num=$Tracking_Num>try again</a>");
...
echo "Login successful, $username. CIP Personnel Tracking Tool access granted. <a href=home.php>Click Here</a>";
      ...
      $_SESSION["authenticated"] = 0;
        echo "Authentication failed. Please check your username/password and <a href=cipapproval.php?Tracking_Num=$Tracking_Num>try again</a>";
}
