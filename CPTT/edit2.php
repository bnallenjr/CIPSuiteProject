...
if($conn) {
 ...
 ?>
 <h2>Edit CIP Authorized Personnel Form (Tracking Number: <?php echo $Tracking_Num;?>)&nbsp <button id="btnAuditHistory"
        type="button"
        class="btn btn-outline-secondary btn-sm">
  Audit History
</button> &nbsp <button type="button" class="btn btn-primary" onclick= "window.open('http:///<?php echo $Tracking_Num; ?>%20-%20<?php echo $FirstName?>%20<?php echo $LastName?>');" >Evidence Folder</button></h2>
		<br>
...
<div class="modal fade" id="AuditTable" style="display:none" tabindex="-1" role="dialog">
